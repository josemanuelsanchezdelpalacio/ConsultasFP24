...
public class LeerProyectoFiltrado {
    ...
    public static void filtrarProyecto(){
        ...
        ListaLeerProjects listaLeerProjects = gson.fromJson(textoJsonProjects, ListaLeerProjects.class);
        ...
        for(DatosLeerProjects proyecto: listaLeerProjects.getProjects()){
